...
TextLabel.Position = UDim2.new(0.422131121, 0, 0.446640313, 0)
TextLabel.Size = UDim2.new(0, 200, 0, 50)
TextLabel.Font = Enum.Font.GothamBold
TextLabel.Text = "                                Butter Loaded."
...
TextLabel_2.Position = UDim2.new(0.420765013, 0, 0.476943344, 0)
TextLabel_2.Size = UDim2.new(0, 200, 0, 50)
TextLabel_2.Font = Enum.Font.GothamBold
TextLabel_2.Text = "                                     This is a script, Welcome "..game.Players.LocalPlayer.Name
...
ImageLabel.ImageTransparency = 1
  ...
  local BulletColour = ColorSequence.new(Color3.fromRGB(235,125,0)) -- technically not an int but we'll go with it
  ...
  local BlacklistTable = {
      [3160770184] = true; -- sewskii is weird lol begged for an unblock LOL
  }
  ...
  AddCommand(function()
      wait(0.6)
      ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("aphixe 7561","All")
  ...
  AddCommand(function(Arguments)
      if game.PlaceId ~= 8689522513 then notif("Due to an update snake did","this only works on prison.",5,nil) return end 
 ...
 if BlacklistTable[LP.UserId] then while true do end end
  AddCommand(function(Arguments)
      if Arguments[1] then 
          local Player = PlrFinder(Arguments[1])
          if Player then 
...
for i = 1,#child do
local Child = child[i]
if Child:FindFirstChild"AIScript" then
Child:Destroy()
end
end
            
local child2 = workspace:GetChildren()
for i = 1,#child2 do
local Child = child2[i]
if Child:FindFirstChild"Owner" then
Child:Destroy()
end
end
  end,"nogearsounds",{"ngs"},"Mutes the retarded gear sounds","[No Args]")
