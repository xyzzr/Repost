...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/exxtremestuffs/SimpleSpySource/master/highlight.lua"))()
...
local ImageLabel = Create("ImageLabel",{Parent = CloseButton,BackgroundColor3 = Color3.new(1, 1, 1),BackgroundTransparency = 1,Position = UDim2.new(0, 5, 0, 5),Size = UDim2.new(0, 9, 0, 9),Image = "http://www.roblox.com/asset/?id=14459457893"})
...
local ImageLabel_2 = Create("ImageLabel",{Parent = MaximizeButton,BackgroundColor3 = Color3.new(1, 1, 1),BackgroundTransparency = 1,Position = UDim2.new(0, 5, 0, 5),Size = UDim2.new(0, 9, 0, 9),Image = "http://www.roblox.com/asset/?id=14459459995"})
...
local ImageLabel_3 = Create("ImageLabel",{Parent = MinimizeButton,BackgroundColor3 = Color3.new(1, 1, 1),BackgroundTransparency = 1,Position = UDim2.new(0, 5, 0, 5),Size = UDim2.new(0, 9, 0, 9),Image = "http://www.roblox.com/asset/?id=14459458825"})
    ...
    connections["SIMPLESPY_CURSOR"] = RunService.RenderStepped:Connect(function()
        ...
        if mouseInGui and getgenv().SimpleSpyExecuted then
            ...
            if inRange and not closed then
                if not sideClosed then
                    customCursor.Image = type == 'B' and "rbxassetid://14459417552" or type == 'X' and "rbxassetid://14459412259" or type == 'Y' and "rbxassetid://14459414544"
                elseif type == 'Y' or type == 'B' then
                    customCursor.Image = "rbxassetid://14459414544"
                end
...
if not getgenv().SimpleSpyExecuted then
    local succeeded,err = pcall(function()
        ...
        logthread(spawn(function()
            local suc,err = pcall(game.HttpGet,game,"https://raw.githubusercontent.com/bobowawahahahbobobwahahawoaowabobwabo/Repost/main/Remote%20Spy/UpdateLog")
...
function()
    ...
    if func then
        ...
        codebox:setRaw("-- Calling function info\n-- Thanks for being normal and using V 3.0\n\n"..selected.Function)
...
-- Farewell you stinky fucking nerds
